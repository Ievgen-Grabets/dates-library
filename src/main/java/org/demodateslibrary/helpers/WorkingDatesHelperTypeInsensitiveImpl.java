...
public class WorkingDatesHelperTypeInsensitiveImpl implements WorkingDatesHelper {
    ...
    public WorkingDatesHelperTypeInsensitiveImpl() {
    }

    public WorkingDatesHelperTypeInsensitiveImpl(Set<LocalDate> holidays, Set<LocalDate> weekends, Set<LocalDate> otherNotWorkingDays) {
        notWorkingDays.addAll(holidays);
        notWorkingDays.addAll(weekends);
        notWorkingDays.addAll(otherNotWorkingDays);
    }

    @Override
    public void addHolidays(Set<LocalDate> holidays) {
        addOtherNotWorkingDays(holidays);
    }

    @Override
    public void addWeekends(Set<LocalDate> weekends) {
        addOtherNotWorkingDays(weekends);
    }

    @Override
    public void addOtherNotWorkingDays(Set<LocalDate> notWorkingDays) {
        notWorkingDays.addAll(notWorkingDays);
    }
